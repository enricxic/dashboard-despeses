...
- **13/09/2026**: Millores a la **Llista de la Compra** (`modules/compres.py`): Afegit un títol clar en taronja. Aprofitant el camp `preuUnit` de la base de dades, ara es calcula i es mostra de forma automàtica l'import estimat per cada línia de producte i un subtotal aproximat per a cada supermercat.
