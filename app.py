...
with tab_intro:
    ...
    intro_col_left, intro_col_right = st.columns([7, 5], gap="medium")
    ...
    with intro_col_right:
        st.markdown("<h4 style='color:#f39c12; margin-top: 0px;'>📋 Últims moviments</h4>", unsafe_allow_html=True)
